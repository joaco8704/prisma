...
public final  class GxWebStd
{
                                           ...
                                           String sCallerPgm )
   {
      ...
      if ( ( httpContext.getWrapped( ) && ( ( nRTEnabled != 0 ) || ( nEnabled != 0 ) ) ) || ! httpContext.getWrapped( ) )
      {
         ...
         com.devopsaazure.GxWebStd.classAttribute( httpContext, sClassString);
         if ( ! (GXutil.strcmp("", sAlign)==0) )
         {
            com.devopsaazure.GxWebStd.styleAttribute( httpContext, sStyleString+"text-align:"+sAlign);
         }
         else
         {
            com.devopsaazure.GxWebStd.styleAttribute( httpContext, sStyleString);
         }
      ...
      if ( nEnabled == 0 )
      {
         ...
         if ( nFormat != 2 )
         {
            ...
            com.devopsaazure.GxWebStd.classAttribute( httpContext, ClassHTML);
            com.devopsaazure.GxWebStd.styleAttribute( httpContext, sOStyle);
            ...
            {
               sEventJsCode = "gx.util.help(" + "'" + httpContext.convertURL( "Help/"+"English/"+GXutil.lower( sCallerPgm)) + "');" ;
            }
            ...
            com.devopsaazure.GxWebStd.gx_start_js_anchor( httpContext, nJScriptCode, sEventJsCode, sUserOnClickCode, sLinkURL, sLinkTarget, "");
         }
         if ( nIsPassword == 0 )
         {
            if ( nFormat == 0 )
         ...
         if ( nFormat != 2 )
         {
            com.devopsaazure.GxWebStd.gx_end_js_anchor( httpContext, sEventJsCode, sUserOnClickCode, sLinkURL);
            httpContext.writeText( "</span>") ;
         }
      }
   }
                                     ...
                                     String sCallerPgm )
   {
      ...
      if ( nEnabled != 0 )
      {
         ...
         {
            sEventJsCode = "gx.util.help(" + "'" + httpContext.convertURL( "Help/"+"English/"+GXutil.lower( sCallerPgm)) + "');" + "return false;" ;
         }
         else if ( nJScriptCode == 7 )
         {
            sEventJsCode = "" + "gx.evt.execCliEvt(" + sEventName + ",this);" ;
      ...
      else
      {
         if ( nDisplay == 1 )
         {
            ...
            if ( GXutil.strcmp(sURL, "") != 0 )
            {
               com.devopsaazure.GxWebStd.styleAttribute( httpContext, "display:block;"+sStyleString);
            }
            else
            {
               com.devopsaazure.GxWebStd.styleAttribute( httpContext, "display:none;"+sStyleString);
            }
                                      ...
                                      String sCallerPgm )
   {
      ...
      if ( GXutil.strcmp(sBorderStyle, "rounded") == 0 )
      {
         ...
         httpContext.writeText( ")\" ") ;
         com.devopsaazure.GxWebStd.styleAttribute( httpContext, sStyleString);
         com.devopsaazure.GxWebStd.classAttribute( httpContext, sClassRoundedBtn);
      ...
      com.devopsaazure.GxWebStd.gx_on_js_event( httpContext, nJScriptCode, sEventJsCode, sUserOnClickCode);
      httpContext.writeText( " ") ;
      httpContext.writeText( sTags) ;
      httpContext.writeText( httpContext.htmlEndTag( HTMLElement.INPUT)) ;
      if ( GXutil.strcmp(sBorderStyle, "rounded") == 0 )
                                   ...
                                   String sInMaster )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         {
            httpContext.writeText( "<span") ;
            com.devopsaazure.GxWebStd.classAttribute( httpContext, ((httpContext.GX_msglist.getItemType((short)(i))==1) ? "gx-error-message" : "gx-warning-message"));
            httpContext.writeText( ">") ;
                                         ...
                                         String sCallerPgm )
   {
      ...
      com.devopsaazure.GxWebStd.classAttribute( httpContext, sClassString);
      com.devopsaazure.GxWebStd.styleAttribute( httpContext, sStyleString);
      com.devopsaazure.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "data-jsevent", sUserOnClickCode, false, false);
      com.devopsaazure.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "data-gxoch0", sEventJsCode, true, false);
      httpContext.writeText( sTags) ;
                                 ...
                                 String sCallerPgm )
   {
      ...
      {
         com.devopsaazure.GxWebStd.gx_bitmap_readonly( httpContext, sInternalName, sImageURL, sLinkURL, sLinkTarget, sAccesskey, sThemeName, nVisible, nEnabled, sAlternateText, sTooltipText, nBorderWidth, nAutoresize, nWidth, nWidthUnit, nHeight, nHeightUnit, nVerticalSpace, nHorizontalSpace, nJScriptCode, sUserOnClickCode, sEventName, sStyleString, ClassHTML, sColumnClassString, sColumnHeaderClassString, sAlign, sImageTags, sUseMap, sJsDynCode, sCallerPgm, sImgSrcSet);
      }
      else
      {
         com.devopsaazure.GxWebStd.gx_multimedia_upload_start( httpContext, sInternalName, nVisible, nWidth, sStyleString);
         ...
         httpContext.writeText( "</span>") ;
         httpContext.writeText( "</a>") ;
         com.devopsaazure.GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sImageURL, sTooltipText, nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", sAlign, sInputTags, nReadOnly, bIsBlob, "image/*", sCallerPgm);
      }
   }
                                          ...
                                          String sImgSrcSet )
   {
      ...
      {
         com.devopsaazure.GxWebStd.gx_start_js_anchor( httpContext, nJScriptCode, sEventJsCode, sUserOnClickCode, sLinkURL, sLinkTarget, "gx-image-link");
      }
      if ( ! (GXutil.strcmp("", sImageURL)==0) )
      {
                                                ...
                                                String sCallerPgm )
   {
      ...
      com.devopsaazure.GxWebStd.gx_single_line_edit( httpContext, sInternalName+"_GXI", sURL, sURL, sInputTags, sEventName, "", "", sTooltipText, "", sUserOnClickCode, 0, "field "+sClassString, sStyleString, "", "", "", 1, 1, 1, "text", "", nWidth, nWidthUnit, nHeight, nHeightUnit, 254, (byte)(0), (short)(2), 0, (byte)(1), (byte)(1), (byte)(0), true, "", sAlign, false, "", sCallerPgm);
                                ...
                                String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
      {
         com.devopsaazure.GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", "", sInputTags, nReadOnly, bIsBlob, "video/*", sCallerPgm);
      }
   }
                                ...
                                String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
      {
         com.devopsaazure.GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", "", sInputTags, nReadOnly, bIsBlob, "audio/*", sCallerPgm);
      }
   }
                               ...
                               String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
      {
         com.devopsaazure.GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", "", sInputTags, nReadOnly, bIsBlob, "*", sCallerPgm);
      }
   }
                                     ...
                                     String sCallerPgm )
   {
      ...
      if ( nFormat == 1 )
      {
         ...
         httpContext.writeText( "<div") ;
         com.devopsaazure.GxWebStd.classAttribute( httpContext, sClassString);
         com.devopsaazure.GxWebStd.styleAttribute( httpContext, sStyle);
                                          ...
                                          String sClassString )
   {
      ...
      else
      {
         ...
         {
            com.devopsaazure.GxWebStd.gx_link_start( httpContext, sLinkURL, sLinkTarget, sClassString);
         }
      }
   }
                                        ...
                                        String sLinkURL )
   {
      ...
      {
         com.devopsaazure.GxWebStd.gx_link_end( httpContext, sLinkURL);
      }
   }
                                        ...
                                        String sExtraStyle )
   {
      ...
      {
         com.devopsaazure.GxWebStd.styleAttribute( httpContext, GXutil.CssPrettify( sExtraStyle));
      }
      httpContext.writeText( ">") ;
                                       ...
                                       boolean bIsRwd )
   {
      ...
      com.devopsaazure.GxWebStd.set_html_headers( httpContext, nContentType, sCacheCtrl, sCacheExp);
      httpContext.setStream();
      if ( nContentType == 0 )
      {
         httpContext.writeTextNL( httpContext.htmlDocType( )) ;
         httpContext.writeTextNL( "<html lang=\"en\""+">") ;
                                        ...
                                        String sCallerPgm )
   {
      ...
      com.devopsaazure.GxWebStd.classAttribute( httpContext, sClassString);
      com.devopsaazure.GxWebStd.styleAttribute( httpContext, sTextAreaStyleString);
      ...
      com.devopsaazure.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "maxlength", sLength, false, true);
      httpContext.writeTextNL( ">") ;
      httpContext.writeValue( sValue) ;
      ...
      if ( nEnabled == 0 )
      {
         ...
         com.devopsaazure.GxWebStd.gx_start_js_anchor( httpContext, nJScriptCode, sEventJsCode, "", sLinkURL, sLinkTarget, "");
         if ( nFormat == 0 )
         {
         ...
         com.devopsaazure.GxWebStd.gx_end_js_anchor( httpContext, sEventJsCode, "", sLinkURL);
         httpContext.writeText( "</span>") ;
      }
   }
                                      ...
                                      String rtPicture )
   {
      ...
      com.devopsaazure.GxWebStd.gx_single_line_edit( httpContext, sCtrlName, sValue, sFormatedValue, sTagsLocal, sEventName, sLinkURL, sLinkTarget, sTooltipText, sPlaceholder, sUserOnClickCode, nJScriptCode, sClassString, sStyleString, sROClassString, sColumnClassString, sColumnHeaderClassString, nVisible, nEnabled, nRTEnabled, sType, sStep, nWidth, nWidthUnit, nHeight, nHeightUnit, nLength, nIsPassword, nFormat, nParentId, bHasTheme, nAutoComplete, nAutoCorrection, bSendHidden, sDomainType, "", false, "", "");
      if ( ( nRTEnabled != 0 ) || ( nEnabled != 0 ) )
      {
         com.devopsaazure.GxWebStd.gx_bitmap_readonly( httpContext, sCtrlName+"_geoLocMe", httpContext.convertURL( "locateMe"), "", "", "", "", nVisible, 1, httpContext.getMessage( "GXM_locatemeoption", ""), httpContext.getMessage( "GXM_locatemeoption", ""), 0, 0, 0, nWidthUnit, 0, nHeightUnit, 0, 0, 4, sUserOnClickCode, sEventName, sStyleString, "GeoLocOption", "", "", "", "", "", "gx.geolocation.getMyPosition(this);", "", "");
      }
   }
                                      ...
                                      String sCallerPgm )
   {
      ...
      com.devopsaazure.GxWebStd.classAttribute( httpContext, sClassString+"Title");
      httpContext.writeText( ">") ;
      httpContext.writeText( sCaption) ;
      httpContext.writeText( "</legend>") ;
   }
