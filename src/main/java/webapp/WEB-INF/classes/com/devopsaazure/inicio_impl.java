...
public final  class inicio_impl extends GXDataArea
{
   public inicio_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public inicio_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( inicio_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2021681028386", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.devopsaazure.inicio", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.devopsaazure.inicio", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb090( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         ClassString = "Button" ;
         StyleString = "" ;
         com.devopsaazure.GxWebStd.gx_button_ctrl( httpContext, bttPais_Internalname, "", "pais", bttPais_Jsonclick, 7, "pais", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11091_client"+"'", TempTags, "", 2, "HLP_inicio.htm");
         ...
         ClassString = "Button" ;
         StyleString = "" ;
         com.devopsaazure.GxWebStd.gx_button_ctrl( httpContext, bttServicio_Internalname, "", "servicio", bttServicio_Jsonclick, 7, "servicio", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e12091_client"+"'", TempTags, "", 2, "HLP_inicio.htm");
         com.devopsaazure.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.devopsaazure.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.devopsaazure.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.devopsaazure.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2021681028390", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("inicio.js", "?2021681028390", false, true);
      /* End function include_jscripts */
   }

   public void init_default_properties( )
   {
      bttPais_Internalname = "PAIS" ;
      bttServicio_Internalname = "SERVICIO" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'PAIS'","{handler:'e11091',iparms:[]");
      setEventMetadata("'PAIS'",",oparms:[]}");
      setEventMetadata("'SER'","{handler:'e12091',iparms:[]");
      setEventMetadata("'SER'",",oparms:[]}");
   }
   ...
   private String bttPais_Internalname ;
   private String bttPais_Jsonclick ;
   private String bttServicio_Internalname ;
   private String bttServicio_Jsonclick ;
   private String sEvt ;
