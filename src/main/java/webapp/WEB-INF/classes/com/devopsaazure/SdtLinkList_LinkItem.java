...
public final  class SdtLinkList_LinkItem extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
   ...
   public com.devopsaazure.SdtLinkList_LinkItem Clone( )
   {
      return (com.devopsaazure.SdtLinkList_LinkItem)(clone()) ;
   }

   public void setStruct( com.devopsaazure.StructSdtLinkList_LinkItem struct )
   {
   ...
   public com.devopsaazure.StructSdtLinkList_LinkItem getStruct( )
   {
      com.devopsaazure.StructSdtLinkList_LinkItem struct = new com.devopsaazure.StructSdtLinkList_LinkItem ();
